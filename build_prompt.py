...
# This file defines the core behavior of the LogiFlow control tower assistant.
...
# Reusable constant for integration
LOGIFLOW_SYSTEM_PROMPT = SYSTEM_PROMPT.strip()

if __name__ == "__main__":
    print(LOGIFLOW_SYSTEM_PROMPT)
