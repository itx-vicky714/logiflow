...
export function TopBar() {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 h-20 z-40 bg-[#f7f9fb]/80 backdrop-blur-xl shadow-[0_4px_24px_rgba(25,28,30,0.06)] border-b border-surface-container/50">
