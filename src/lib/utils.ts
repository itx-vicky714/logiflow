...
export const SAMPLE_SHIPMENTS = [
  ...
  { origin: 'Kolkata',   destination: 'Delhi',      mode: 'road' as ShipmentMode, cargo_type: 'FMCG',            weight_kg: 45000, declared_value: 3200000, supplier_name: 'ITC Limited',         supplier_email: 'vendor@itc.com',        status: 'delayed'    as ShipmentStatus, eta_hours: 48, vehicle_number: 'WB-12-F-7891',  transporter_name: 'Safexpress',          priority: 'high' },
  { origin: 'Pune',      destination: 'Ahmedabad',  mode: 'road' as ShipmentMode, cargo_type: 'Auto Parts',      weight_kg: 5000,  declared_value: 380000,  supplier_name: 'Mahindra Supply',     supplier_email: 'logistics@mahindra.com',status: 'in_transit' as ShipmentStatus, eta_hours: 8,  vehicle_number: 'MH-12-ZZ-4567', transporter_name: 'Blue Dart Freight',   priority: 'normal' },
  { origin: 'Delhi',     destination: 'Mumbai',     mode: 'rail' as ShipmentMode, cargo_type: 'Machinery',       weight_kg: 32000, declared_value: 5600000, supplier_name: 'L&T Infrastructure',  supplier_email: 'supply@landt.com',      status: 'on_time'    as ShipmentStatus, eta_hours: 28, vehicle_number: 'IR-56234-D',    transporter_name: 'Indian Railways',     priority: 'normal' },
  ...
  { origin: 'Jaipur',    destination: 'Surat',      mode: 'road' as ShipmentMode, cargo_type: 'Handicrafts',     weight_kg: 3000,  declared_value: 620000,  supplier_name: 'Rajasthan Exports',   supplier_email: 'trade@rajexports.com',  status: 'pending'    as ShipmentStatus, eta_hours: 12, vehicle_number: 'RJ-14-CD-3421', transporter_name: 'Gati Logistics',      priority: 'normal' },
  ...
  { origin: 'Patna',     destination: 'Surat',      mode: 'road' as ShipmentMode, cargo_type: 'Textiles',        weight_kg: 8500,  declared_value: 1100000, supplier_name: 'Bihar Weavers',       supplier_email: 'contact@bweavers.in',   status: 'in_transit' as ShipmentStatus, eta_hours: 42, vehicle_number: 'BR-01-XY-9999', transporter_name: 'VRL Logistics',       priority: 'normal' },
  { origin: 'Mumbai',    destination: 'Bangalore',  mode: 'air'  as ShipmentMode, cargo_type: 'Electronics',     weight_kg: 950,   declared_value: 3500000, supplier_name: 'Samsung India',       supplier_email: 'supply@samsung.com',    status: 'on_time'    as ShipmentStatus, eta_hours: 4,  vehicle_number: 'IX-4455',       transporter_name: 'SpiceJet Cargo',      priority: 'urgent' },
  { origin: 'Chennai',   destination: 'Hyderabad',  mode: 'road' as ShipmentMode, cargo_type: 'Auto Parts',      weight_kg: 4200,  declared_value: 750000,  supplier_name: 'Hyundai Motors',      supplier_email: 'parts@hyundai.co.in',   status: 'in_transit' as ShipmentStatus, eta_hours: 14, vehicle_number: 'TN-09-PQ-8888', transporter_name: 'TVS Logistics',       priority: 'normal' },
  { origin: 'Delhi',     destination: 'Ahmedabad',  mode: 'rail' as ShipmentMode, cargo_type: 'FMCG',            weight_kg: 18000, declared_value: 2100000, supplier_name: 'Nestle India',        supplier_email: 'dist@nestle.com',       status: 'on_time'    as ShipmentStatus, eta_hours: 22, vehicle_number: 'IR-99887-A',    transporter_name: 'Indian Railways',     priority: 'normal' },
  { origin: 'Kolkata',   destination: 'Pune',       mode: 'road' as ShipmentMode, cargo_type: 'Chemicals',       weight_kg: 12000, declared_value: 950000,  supplier_name: 'Bengal Chemicals',    supplier_email: 'sales@bengalchem.in',   status: 'delayed'    as ShipmentStatus, eta_hours: 60, vehicle_number: 'WB-04-MN-3333', transporter_name: 'Rivigo Fleet',        priority: 'high' },
  { origin: 'Nagpur',    destination: 'Mumbai',     mode: 'road' as ShipmentMode, cargo_type: 'Agriculture',     weight_kg: 15000, declared_value: 400000,  supplier_name: 'Maha Farmers Co',     supplier_email: 'export@mahafarm.in',    status: 'pending'    as ShipmentStatus, eta_hours: 15, vehicle_number: 'MH-31-AA-1111', transporter_name: 'Mahindra Logistics',  priority: 'normal' },
  { origin: 'Kochi',     destination: 'Chennai',    mode: 'sea'  as ShipmentMode, cargo_type: 'Spices',          weight_kg: 22000, declared_value: 3200000, supplier_name: 'Kerala Spices Board', supplier_email: 'trade@spices.gov',    status: 'in_transit' as ShipmentStatus, eta_hours: 48, vehicle_number: 'INL-VESSEL-12', transporter_name: 'Shipping Corp India', priority: 'normal' },
  { origin: 'Chandigarh',destination: 'Delhi',      mode: 'road' as ShipmentMode, cargo_type: 'Machinery',       weight_kg: 8000,  declared_value: 1500000, supplier_name: 'Punjab Tractors',     supplier_email: 'sales@ptractors.in',    status: 'on_time'    as ShipmentStatus, eta_hours: 6,  vehicle_number: 'PB-01-AB-7777', transporter_name: 'Delhivery Freight',   priority: 'normal' },
  { origin: 'Indore',    destination: 'Ahmedabad',  mode: 'road' as ShipmentMode, cargo_type: 'Textiles',        weight_kg: 6500,  declared_value: 850000,  supplier_name: 'MP Cotton Mills',     supplier_email: 'info@mpcotton.in',      status: 'delivered'  as ShipmentStatus, eta_hours: -5, vehicle_number: 'MP-09-CD-4444', transporter_name: 'Safexpress',          priority: 'normal' },
  { origin: 'Bhopal',    destination: 'Jaipur',     mode: 'road' as ShipmentMode, cargo_type: 'FMCG',            weight_kg: 4000,  declared_value: 600000,  supplier_name: 'Central Dist',        supplier_email: 'ops@central.in',        status: 'in_transit' as ShipmentStatus, eta_hours: 16, vehicle_number: 'MP-04-EF-5555', transporter_name: 'VRL Logistics',       priority: 'normal' },
  { origin: 'Guwahati',  destination: 'Kolkata',    mode: 'rail' as ShipmentMode, cargo_type: 'Agriculture',     weight_kg: 25000, declared_value: 1800000, supplier_name: 'Assam Tea Estates',   supplier_email: 'export@assamtea.in',    status: 'delayed'    as ShipmentStatus, eta_hours: 36, vehicle_number: 'IR-33445-C',    transporter_name: 'Indian Railways',     priority: 'high' },
  { origin: 'Visakhapatnam', destination: 'Chennai',mode: 'sea'  as ShipmentMode, cargo_type: 'Metals',          weight_kg: 35000, declared_value: 4500000, supplier_name: 'Vizag Steel',         supplier_email: 'sales@vizagsteel.in',   status: 'on_time'    as ShipmentStatus, eta_hours: 24, vehicle_number: 'INL-VESSEL-09', transporter_name: 'Shipping Corp India', priority: 'normal' },
  { origin: 'Delhi',     destination: 'Bangalore',  mode: 'air'  as ShipmentMode, cargo_type: 'IT Equipment',    weight_kg: 1500,  declared_value: 5500000, supplier_name: 'Dell India',          supplier_email: 'logistics@dell.com',    status: 'in_transit' as ShipmentStatus, eta_hours: 5,  vehicle_number: 'IX-8899',       transporter_name: 'Blue Dart Aviation',  priority: 'urgent' },
  { origin: 'Surat',     destination: 'Mumbai',     mode: 'road' as ShipmentMode, cargo_type: 'Textiles',        weight_kg: 5500,  declared_value: 2200000, supplier_name: 'Gujarat Diamonds',    supplier_email: 'secure@gdiamonds.in',   status: 'on_time'    as ShipmentStatus, eta_hours: 8,  vehicle_number: 'GJ-05-AB-1234', transporter_name: 'Secure Transit',      priority: 'high' }
];
